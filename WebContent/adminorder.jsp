...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="overflow: auto;">
    ...
    <form action="reachorder" method="post" onsubmit="return check()">
		<div class="input-group col-md-3" style="margin-top:0px positon:relative;margin-left:30%">  
       		<input type="text" class="form-control" placeholder="请输入订单号" name="orderid" id="searchid" /> 
       			<span id="error_in"></span> 
            	<span class="input-group-btn">  
