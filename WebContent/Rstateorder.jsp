    ...
    <section class="content">
      ...
      <div class="orderdata">
        <div class="persondetaileddate">
            <s:iterator value="#session.stateorder" var="my">
            <div class="orders">
			    <div>	
			    ...
			    <div>
			    	<div class="orderaddress">
			    		收货地址:<s:property value="#my.oaddress"/>
			    	</div>
			    ...
			    <div style="margin-left:5%;margin-top:2%">
			    	...
			    	<div>
			    		...
			    		onclick="javascript:window.location.href='rstate?orderid='+<s:property value='#my.orderId'/>">
			    			点击订单已发货
			    		</button>
			    	</div>
			    </div>
        ...
        <div style="margin-left:40%">
        	...
        	<s:if test='%{currentPage>1}'>
				<li><a href="revicestate?pageNo=${currentPage-1}">&laquo;</a></li>
			</s:if>
			<c:forEach var="i" begin="1" end="${totalPage}">
			<li><a href="revicestate?pageNo=${i}">${i}</a></li>
			</c:forEach>
			<s:if test="currentPage<totalPage">
				<li><a href="revicestate?pageNo=${currentPage+1}">&raquo;</a></li>
			</s:if>
			</ul>
        </div>
      </div>
