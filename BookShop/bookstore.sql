...
CREATE TABLE `address` (
  ...
  PRIMARY KEY (`aId`),
  KEY `uId` (`uId`),
  CONSTRAINT `FKbqr3vvj4ecw61f0cp02wlp3px` FOREIGN KEY (`uId`) REFERENCES `user` (`uId`),
  CONSTRAINT `address_ibfk_1` FOREIGN KEY (`uId`) REFERENCES `user` (`uId`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=gb2312;

/*Data for the table `address` */

insert  into `address`(`aId`,`uId`,`address`,`zipCode`,`note`) values (2,2,'珠海北京理工大学珠海学院','123456',NULL),(3,2,'广东省珠海市香洲区北京理工大学珠海学院','518111',NULL),(4,2,'广东省珠海北理工','123456',NULL),(5,2,'广东省珠海横琴','123456',NULL),(6,2,'广东省广州白云山','1234',NULL),(7,3,'广东省珠海市北京理工大学珠海学院','123456',NULL),(8,10,'广东12','12312',NULL),(9,10,'广东省珠海市香洲区北京师范大学珠海分校','123456',NULL),(10,11,'广东省珠海市香洲区北京理工大学珠海学院','518111',NULL),(11,11,'广东省珠海市香洲区北京师范大学珠海分校','123456',NULL),(12,11,'广东省珠海市香洲区吉林大学珠海学院','658431',NULL);
...
CREATE TABLE `order` (
  ...
  KEY `uId` (`uId`),
  KEY `osId` (`osId`),
  CONSTRAINT `FK1nfp4189dxlp3eeuloqpxw4rc` FOREIGN KEY (`osId`) REFERENCES `orderstate` (`osId`),
  CONSTRAINT `FKnyhikotnyd3hlvmq0ix76bvlo` FOREIGN KEY (`uId`) REFERENCES `user` (`uId`),
...
) ENGINE=InnoDB AUTO_INCREMENT=236 DEFAULT CHARSET=gb2312;

/*Data for the table `order` */

insert  into `order`(`oId`,`shipAddress`,`receive`,`orderDate`,`uId`,`osId`,`note`) values (233,'\n											广东省珠海市北京理工大学珠海学院\n										','\n											用户2\n				','2017-06-06 12:35:25',3,2,NULL),(234,'\n											广东省珠海市北京理工大学珠海学院\n										','\n											用户2\n				','2017-06-06 12:42:04',3,2,NULL),(235,'\n											广东省珠海市北京理工大学珠海学院\n										','\n											用户2\n				','2017-06-06 14:01:25',3,2,NULL);
...
CREATE TABLE `orderdetail` (
  ...
  KEY `uId` (`oId`),
  KEY `bId` (`bId`),
  CONSTRAINT `FK1nyj7vkjmcit4f19h1naj5e06` FOREIGN KEY (`oId`) REFERENCES `order` (`oId`),
  CONSTRAINT `FKgwfddwgqumdxvrcpq8xbtggxr` FOREIGN KEY (`bId`) REFERENCES `book` (`bId`),
  CONSTRAINT `orderdetail_ibfk_2` FOREIGN KEY (`bId`) REFERENCES `book` (`bId`),
  CONSTRAINT `orderdetail_ibfk_3` FOREIGN KEY (`oId`) REFERENCES `order` (`oId`)
) ENGINE=InnoDB AUTO_INCREMENT=260 DEFAULT CHARSET=gb2312;

/*Data for the table `orderdetail` */

insert  into `orderdetail`(`odId`,`oId`,`bId`,`quantity`,`bookPrice`,`note`) values (257,233,10,3,59,NULL),(258,234,8,1,46,NULL),(259,235,8,1,46,NULL);
...
CREATE TABLE `shoppingcart` (
  ...
  KEY `uId` (`uId`),
  KEY `bId` (`bId`),
  CONSTRAINT `FKouwt5c49d4pity8f5nyavod8e` FOREIGN KEY (`bId`) REFERENCES `book` (`bId`),
  CONSTRAINT `FKrdqqqtppvlsahu2enuelwde47` FOREIGN KEY (`uId`) REFERENCES `user` (`uId`),
...
) ENGINE=InnoDB AUTO_INCREMENT=283 DEFAULT CHARSET=gb2312;

/*Data for the table `shoppingcart` */

insert  into `shoppingcart`(`sId`,`uId`,`bId`,`quantity`,`note`) values (222,1,4,1,NULL),(248,2,10,1,NULL),(251,2,9,1,NULL),(264,10,8,1,NULL),(275,11,8,1,NULL),(276,11,9,2,NULL),(277,11,4,1,NULL),(278,11,1,1,NULL),(279,11,2,1,NULL);
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`uId`),
  KEY `utId` (`utId`),
  CONSTRAINT `FKtl2g03ld6lqgmyavsa7mfw8cu` FOREIGN KEY (`utId`) REFERENCES `usertype` (`utId`),
